...
import profilePic from "../assets/RafaelMartinsProfile.jpeg";
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    Estágiario de Desensolvimento de Software
                    </motion.span>
                    <motion.p 
            ...
            <div className=" w-full lg:w-1/2 lg:p-8 ">
                ...
                transition={{duration: 1, delay:1.2}}
                 src={profilePic} alt="Rafael Martins" className=" w-64 h-64 lg:w-80 lg:h-80 rounded-2xl flex-shrink-0 " />      
                </div>  
            </div>
